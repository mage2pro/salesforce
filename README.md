The extension integrates your Magento 2 store with the **[Salesforce](https://salesforce.com)** CRM software.

## How to buy
The extension is not released yet, so there is no way to buy it just now.  
The extension will be released before 2017-07-15.   
...
## Support
- [The extension's **forum** branch](https://mage2.pro/c/extensions/salesforce).
...
- [Subscribe](https://mage2.pro/t/2540) to the extension's [forum branch](https://mage2.pro/c/extensions/salesforce).
